...
import { AiFillPhone ,AiOutlineShoppingCart,AiOutlineHeart} from 'react-icons/ai';
  ...
  return (
    <div className={styles.container}>
      <div className={styles.containerFront}>
        ...
        <Link href="/checkout" passHref><AiOutlineShoppingCart className={styles.shoppingCart} size="22px"/></Link>
